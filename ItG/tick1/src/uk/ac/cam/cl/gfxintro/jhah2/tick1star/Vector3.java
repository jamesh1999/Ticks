...
public class Vector3 {
	...
	public static Vector3 randomInsideUnitSphere() {
		...
		return fromSphericalCoords(r, phi, theta);
	}
	...
	public double r() { return magnitude(); }
	public double theta() { return Math.atan2(Math.hypot(x, y), z); }
	public double phi() { return Math.atan2(y, x); }
	public static Vector3 fromSphericalCoords(double r, double phi, double theta)
	{
